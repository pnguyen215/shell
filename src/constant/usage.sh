...
USAGE_SHELL_CRYPTOGRAPHY_VERIFY_PASSWORD_HASH="
shell::cryptography::verify_password_hash function
Verifies a password against a stored hash using OpenSSL.
...
Description:
  This function verifies a password against a stored hash using OpenSSL.
"
