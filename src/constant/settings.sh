...
# SHELL_PROJECT_GITHUB_WORKFLOW_CI_RELEASE_NOTIFICATION constant
...
SHELL_PROJECT_GITHUB_WORKFLOW_CI_RELEASE_NOTIFICATION="https://raw.githubusercontent.com/pnguyen215/wsdkit.keys/master/devops/github_workflow/ci_notify.yml"
