...
alias sgemcheck='shell::evaluate_gemini_english_grammar'  # check grammar english by Gemini
alias sgrammarai='shell::evaluate_gemini_english_grammar' # check grammar english by Gemini
alias seg='shell::evaluate_gemini_english_grammar'        # check grammar english by Gemini
