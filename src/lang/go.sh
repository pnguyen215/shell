...
# Parameters:
#   -n: Optional.
#   If provided, the command is printed using shell::logger::command_clip instead of executed.
...
#   - Supports dry-run and asynchronous execution via shell::logger::command_clip and shell::async.
